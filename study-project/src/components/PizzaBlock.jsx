...
export default function PizzaBlock({title, price, imageUrl, sizes, types}) { // (props) {props.title} {props.price}
	const [pizzaCount, setPizzaCount] = useState(0); // начальное значение count = 0  
